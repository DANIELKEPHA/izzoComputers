...
export default function CartPage() {
    ...
    const totalPriceFromBackend = cartData?.totalPrice
        ? Number(cartData.totalPrice.toString())
        : 0;

    // Hardcoded constants (can be moved to config later)
    ...
    const discountAmount = appliedCoupon
        ? totalBeforeDiscount * (appliedCoupon.discount / 100)
        : 0;
                                                ...
                                                <div className="flex-1 space-y-4">
                                                    <div>
                                                        <Link
                                                            ...
                                                            className="font-bold text-xl text-gray-900 hover:text-blue-600 line-clamp-2"
                                                        >
                                                            {product.name}
                                                        </Link>
